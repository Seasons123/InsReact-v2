                        ...
                        <div className="w1008 margin mar_20" onLoad={this.getCompanies()}>
                            ...
                            <span className="fr pad_L">您的位置： <a href="home.jsp">首页</a> &gt; 人寿保险 &gt; <a
                                ...
                                <div className="article">
                                        ...
                                        <div className="lifeSearch">
                                            <ul>
                                                ...
                                                <li className="searchContain searchContain_com">
                                                    ...
                                                    <div  >
                                                        <select id="company" onChange={this.getSelectCompany} className="searchSelect">
                                                ...
                                                <li className="searchContain searchContain_ins">
                                                    ...
                                                    <div>
                                                        <select id="lifeInsuranceType" onChange={this.getSelectLifeInsuranceType}>
                                    ...
                                    <div className="productDetails" onLoad={this.getInsurancesList()}>
